...
O jar de cookies é a conta: quem o tiver entra sem senha e sem segundo fator.
Ele fica no disco de uma máquina de trabalho, ao lado de backups,
sincronizações e ferramentas de busca.
