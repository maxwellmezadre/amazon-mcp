...
**Todo valor monetário é INTEGER em centavos.** A conversão para decimal
acontece uma única vez, na saída da tool.
...
cada uma, mas nunca as datas de vencimento. O cronograma é derivado na leitura e
sempre marcado como projeção.
