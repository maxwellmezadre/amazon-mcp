...
// stream. Optional file via AMAZON_LOG_FILE. Secrets (cookie values) never
// hit a log line: every message goes through redaction, and the secret list can
// be a provider so it follows Amazon's cookie rotation without rebuilding the
// logger.
